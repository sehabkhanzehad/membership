...
<aside id="sidebar"
    ...
    <nav class="px-3 py-4 space-y-1 flex-1">
        ...
        <a href="{{ route('dashboard') }}" class="group flex items-center gap-3 rounded-xl px-3 py-2 text-gray-700 hover:bg-gray-100">
            <svg class="h-5 w-5 text-gray-400 group-hover:text-emerald-600" viewBox="0 0 24 24" fill="currentColor">
        ...
        {{-- <a href="#" class="group flex items-center gap-3 rounded-xl px-3 py-2 text-gray-700 hover:bg-gray-100">
            <svg class="h-5 w-5 text-gray-400 group-hover:text-emerald-600" viewBox="0 0 24 24" fill="currentColor">
